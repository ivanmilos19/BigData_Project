...
def convert_raw_to_formatted(file_name, current_day):
    RATING_PATH = os.path.join(DATALAKE_ROOT_FOLDER, "airflow", "datalake", "raw", "ANI", "Top_anime", current_day, file_name)
    FORMATTED_RATING_FOLDER = os.path.join(DATALAKE_ROOT_FOLDER, "airflow", "datalake", "formatted", "ANI", "Top_anime", current_day)
